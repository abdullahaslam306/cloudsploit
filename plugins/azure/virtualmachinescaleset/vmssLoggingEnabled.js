...
module.exports = {
    title: 'Scale Sets Logging Enabled',
    category: 'Virtual Machines',
    domain: 'Compute',
    description: 'Ensures that logging is enabled for virtual machine scale sets.',
    ...
    link: 'https://learn.microsoft.com/en-us/azure/azure-monitor/agents/diagnostics-extension-overview',
        ...
        async.each(locations.virtualMachineScaleSets, (location, rcb) => {
            ...
            async.each(virtualMachineScaleSets.data, (virtualMachineScaleSet, scb) => {
                ...
                const healthMonitoring = scaleSetExtensions.length 
                    ? scaleSetExtensions.some((extension) => (extension.type === 'AzureMonitorLinuxAgent' || extension.type === 'AzureMonitorWindowsAgent')) 
                    : false;
